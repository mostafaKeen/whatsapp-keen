...
<script>
    ...
    function addMessageToHistory(item) {
        ...
        if (item.file_url || item.external_url) {
            ...
            var downloadUrl = item.file_url;
            if (item.external_url) {
                downloadUrl = item.external_url.replace('download=false', 'download=true');
                if (!downloadUrl.includes('download=') && !downloadUrl.includes('download=true')) {
